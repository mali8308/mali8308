...
- **Genomics**: Bulk RNA-seq, single-cell RNA-seq, RNA velocity, ChIP-seq, DNA methylation, chromatin accessibility (ATAC-seq), immune receptor profiling, CITE-seq, spatial transcriptomics, variant calling, splicing analysis, functional analysis (ontology and set enrichment analysis). 
